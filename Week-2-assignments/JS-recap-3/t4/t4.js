import {dist} from '../lib/euclidean.js';
...
document.body.appendChild(locationElm);
const pElm = document.createElement('p');
pElm.innerText = 'My location is:';
locationElm.appendChild(pElm);
const myLocation = document.createElement('p');
locationElm.appendChild(myLocation);

function getLocation() {
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(success, error, options);
  } else {
    myLocation.innerText = 'Geolocation is not supported by this browser.';
  }
}
...
function success(position) {
  ...
  restaurants.sort((a, b) => {
    return (
      dist(myCoords, a.location.coordinates) -
      dist(myCoords, b.location.coordinates)
    );
  });

  myLocation.innerText =
    'Latitude: ' +
...
function error() {
  myLocation.innerText = 'Unable to retrieve your location';
}
